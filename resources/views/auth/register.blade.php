                                ...
                                <div class="p-4 my-auto">
                                    ...
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control @error('fullName') is-invalid @enderror" type="text" name="fullName" id="fullName" placeholder="Enter your full name" value="{{ old('fullName') }}" required autofocus autocomplete="fullName">
                                            @error('fullName')
